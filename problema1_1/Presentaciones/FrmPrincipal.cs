...
namespace problema1_1.Presentaciones
{
    public partial class FrmPrincipal : Form
    {
        ...
        {
            FrmNuevoPlanDeEstudio frmNuevoPlanDeEstudio = new FrmNuevoPlanDeEstudio();
            frmNuevoPlanDeEstudio.ShowDialog();
        }
        ...
        {
            FrmConsultarCarreras frmConsultarCarrera = new FrmConsultarCarreras();
